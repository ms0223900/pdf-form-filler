...
- `public/templates/` 目錄中的預設範本（此 US 僅串接，範本檔案由 US-009 提供）
...
**驗收條件**：
- [ ] 頁面顯示已上傳的 PDF 列表（卡片樣式，顯示檔名與上傳日期）
- [ ] 無任何 PDF 時顯示提示引導使用者上傳或選擇範本
- [ ] 點擊「上傳 PDF」按鈕可開啟檔案選擇器
- [ ] 支援拖曳 PDF 到上傳區域
- [ ] 上傳非 PDF 檔案時顯示錯誤訊息
- [ ] 上傳後 PDF 出現在列表中，資料存入 IndexedDB
- [ ] 預設範本區域顯示內建範本
- [ ] 點擊任一 PDF 導航至 `/fill/[id]`
- [ ] 頁面初始載入時從 IndexedDB 讀取既有 PDF 列表
- [ ] 在手機版面垂直排列，卡片滿寬顯示
- [ ] `npx tsc --noEmit` 無錯誤
